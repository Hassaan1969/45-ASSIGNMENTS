...
console.log(animals);
console.log(x);
function gree(){              // function in typescript
    console.log("Hello There ! Welcome to School");
}
gree();
gree();
gree();
function greet(firstname:string) // here function has an argument that is added in function call
{
